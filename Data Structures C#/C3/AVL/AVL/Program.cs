    ...
    internal class Program
    {
        ...
        static void FileInsert(string folder, string filename)
        {
            ...
            else
            {
                foreach (string line in fileToAdd)
                {
                    ...
                    {
                        avl.Add(wordAdd);  // Add each valid word to the tree
                    }
                }
        ...
        static int OpMenuUI()
        {
            ...
            while (opt < 1 || opt > 7)
            {
                ...
                Console.WriteLine("[5] - Tree Details");
                Console.WriteLine("[6] - Time Complexity Report");
                Console.WriteLine("[7] - Demonstration");
        ...
        static void OpMenuSwitch(string folder, string fileName)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Press any key to continue...");
                Console.ReadKey();
            } while (opt != 8);  // Only exit the loop when the user chooses option 8.
        }
        #endregion
        ...
        static void DeleteOp()
        {
            ...
            Console.WriteLine("Enter a word that you'd like to DELETE: ");
            string input = Console.ReadLine();
        ...
        {
            avl.Clear(); // clears the list
            ReadFile(folder, $"{numWords}-words.txt");

            Stopwatch sw = Stopwatch.StartNew();
            sw.Start();

            //find operation to add the word "Hammer"
            avl.Add("Hammer");
        ...
        static void Demonstration()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Press any key to go to the details function...");
            Console.ReadKey();
            #endregion

            #region Details
            Console.Clear();
            Console.WriteLine("--- Tree Details ---\n");
            string details = avl.Details();
            Console.WriteLine(details);
            ...
            Console.Clear();
            Console.WriteLine("--- Pre Order ---\n");
            string preOrder = avl.PreOrder();
            Console.WriteLine(preOrder);

            Console.WriteLine();
            Console.WriteLine("Press any key to go to in-order function...");
            Console.ReadKey();
            #endregion
            ...
            Console.WriteLine();
            Console.WriteLine("\nPress any key to go to time complexity...");
            Console.ReadKey();
            #endregion
